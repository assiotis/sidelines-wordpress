/**
 * Lightning JS library to load Sidelines without blocking the window onload
 * and document ready events. It also provides encapsulation to eliminate
 * javascript conflicts.
 *
 * The library works by creating a hidden iFrame and hooking into the onLoad
 * event of the body. When that fires, it asynchronously loads our code by
 * creating a <script src="http://sidelinesapp.com/.../sidelines-sdk.js"> tag
 * in the iFrame's <head></head>
 *
 * Tested on:
 *
            ...
            (function() {
                ...
                var downloadIntoFrameContext = function() {
                    ...
                    try {
                        ...
                        // buildInnerFrameHTML returns something like:
                        //"<head></head><body onload="var d=document;d.getElementsByTagName('head')[0].appendChild(d.createElement('script')).src='http://scripturl'"></body>
